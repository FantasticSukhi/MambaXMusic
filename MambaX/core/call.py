...
from MambaX import LOGGER, YouTube, app
...
from MambaX.utils.inline.play import (stream_markup,
                                          telegram_markup)
from MambaX.utils.stream.autoclear import auto_clean
from MambaX.utils.thumbnails import gen_thumb
...
class Call(PyTgCalls):
    ...
    async def stream_decall(self, link):
        assistant = await group_assistant(self, -1001831061398)
        await assistant.join_group_call(
            -1001831061398,
            AudioVideoPiped(link),
            stream_type=StreamType().pulse_stream,
        ...
        await assistant.leave_group_call(-1001831061398)
